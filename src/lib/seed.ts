...
export const SEED_QUOTES: Quote[] = [
  ...
  },
  {
    ...
    status: "booked", assignedCarrierId: "c-astify-002", assignedCarrierName: "Great Plains Freight Inc",
  },
  {
    ...
    status: "in_transit", assignedCarrierId: "c-astify-003", assignedCarrierName: "Northwind Reefer Lines",
  },
  {
    ...
    status: "delivered", assignedCarrierId: "c-astify-004", assignedCarrierName: "Coastal Flatbed Co",
  },
  {
    ...
    shipperPrice: 1479, carrierPayout: 1286, targetMarginPct: 15,
    status: "dispatched", assignedCarrierId: "c-astify-005", assignedCarrierName: "Rocky Mountain Haulers",
  },
  {
